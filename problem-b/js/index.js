...
*/
let type = document.querySelector('#dobInput');
type.addEventListener('input', function() {
  let inputAge = getYearsSince(type.value);
  if(inputAge <  13||inputAge > 200) {
    type.setCustomValidity("You need to be at least 13 years old.");
